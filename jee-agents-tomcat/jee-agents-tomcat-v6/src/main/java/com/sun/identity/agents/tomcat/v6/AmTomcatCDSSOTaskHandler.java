 ...
 *
 * $Id: AmTomcatCDSSOTaskHandler.java,v 1.2 2008/11/28 12:35:31 saueree Exp $
 *
 ...
 * requests for Single Sign-On for Tomcat
 *
 */
public class AmTomcatCDSSOTaskHandler extends CDSSOTaskHandler {

    public AmTomcatCDSSOTaskHandler(Manager manager) {
        super(manager);
    }
