...
public class Jetty12Container extends WebContainer {

    public Jetty12Container() {
        this.container = new FixedHostPortGenericContainer<>("jetty:12.0")
                ...
                .withCopyToContainer(
                        Transferable.of("--modules=ee10-webapp,ee10-deploy,ee10-servlet,ee10-jsp,ee10-ext"),
                        "/var/lib/jetty/start.d/ee10-modules.ini"
                )
                .withCopyToContainer(
                        (MountableFile.forClasspathResource("docker/jetty/12/ee10-ext.mod")),
                        "/usr/local/jetty/modules/ee10-ext.mod"
                )
                .withCopyToContainer(
    ...
    public void mount(Transferable transferable) {
        container.withCopyToContainer(transferable, "/var/lib/jetty/lib/ee10/ext/");
    }
}
